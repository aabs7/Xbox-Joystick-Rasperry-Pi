...
class Joystick:
    ...
    def __init__(self,refreshRate = 30):
        ...
        while not found:#waitTime > time.time() and not found:
	    waitTime = time.time() + 2
